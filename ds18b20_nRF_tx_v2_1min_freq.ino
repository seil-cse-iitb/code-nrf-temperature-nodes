...
char node_id_String[] = "27";  //node id
...
//const uint64_t wAddress = wAddress_lab;
//const uint64_t wAddress = wAddress_SIC305;
const uint64_t wAddress = wAddress_lecture_hall;
...
float get_DS18B20_Temperature() {
  ...
  do {
    ...
    temp = DS18B20.getTempCByIndex(0); // Why "byIndex"?
...
void loop()
{
  ...
  float temperature1 = get_DS18B20_Temperature();
  float humidity1 = 0.99;  //using dummy hunidity value to use exisiting dht based setup as it is 
